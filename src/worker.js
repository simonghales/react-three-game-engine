                ...
                fixtures.forEach(function (fixture, fixtureIndex) {
                    ...
                    switch (shape) {
                        case BodyShape.box:
                            ...
                            bodyShape = planckJs.Box(hx / 2, hy / 2, center ? planckJs.Vec2(center[0], center[1]) : undefined);
                            break;
                    ...
                    if (attachToRope) {
                        ...
                        if (body) {
                            var distanceJoint = planckJs.DistanceJoint({
                                ...
                                dampingRatio: 0.5,
                                length: 0.15
                            }, startingBody, body, position != null ? position : planckJs.Vec2(0, 0), position != null ? position : planckJs.Vec2(0, 0));
                            var rope2 = world.createJoint(planckJs.RopeJoint(ropeJointDef, startingBody, body, position != null ? position : planckJs.Vec2(0, 0)));
...
var useStepProcessed = function useStepProcessed(tickRef) {
    var _useAppContext3 = useAppContext(),
        ...
        buffersRef = _useAppContext3.buffersRef;
...
var useHandleBeginCollision = function useHandleBeginCollision() {
    ...
    var sendCollisionBeginEvent = React.useCallback(function (uuid, data, fixtureIndex, isSensor) {
        var update = {
...
var useHandleEndCollision = function useHandleEndCollision() {
    ...
    var sendCollisionEndEvent = React.useCallback(function (uuid, data, fixtureIndex, isSensor) {
        var update = {
...
console.log('i am physics worker...'); // because of some weird react/dev/webpack/something quirk
